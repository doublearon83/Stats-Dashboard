...
strokedata$Type <- c(rep("Best-fit",100),rep("Observed",8))
...
h <- ggplot() + 
  ...
  scale_color_manual(values = c("Best-fit" = "black", "Observed" = "red"))+
#  scale_color_discrete(name="Statistic",
#                       breaks=c("Best-fit","Observed"),
#                       labels=c("Best-fit","Observed"))+
